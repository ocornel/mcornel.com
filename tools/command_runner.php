                ...
                <form class="text-left">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label for="name">Your Command</label>
                            <input id="command" name="command" type="text" placeholder="" class="form-control input-md">
                        </div>
                        <!-- Button (Double) -->
                        <div class="form-group">
                            <div class="col-md-12 text-center">
...
<script src="js/command_runner.js"></script>
</body>
</html>