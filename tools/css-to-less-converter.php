...
<html lang="en">
<head>
    <link rel="stylesheet" type="text/css" href="css/css_to_less_converter.css" media="all"/>
                        ...
                        <div class="form-group buttons_div">
                            <div class="col-md-12">
                                <ul class="nav_ul ul_buttons">
                                    <li><a id="load_url" href="css-to-less-converter.php#">Load&nbsp;Url</a></li>
                                    <li><a id="browse" href="css-to-less-converter.php#">Browse</a></li>
                                    <li><a id="convert" href="css-to-less-converter.php#">Convert</a></li>
                                    <li><a id="beautify_css" href="css-to-less-converter.php#">Beautify&nbsp;css</a></li>
                                    <li><a id="minify_css" href="css-to-less-converter.php#">Minify&nbsp;css</a></li>
                                    <li><a id="editor_options" data-toggle="modal" data-target="#editor_options_modal" data-backdrop="false" href="css-to-less-converter.php#">Editor&nbsp;Options</a></li>
                                    <li><a id="download" href="css-to-less-converter.php#">Download</a></li>
                                    <li><a id="clear" href="css-to-less-converter.php#">Clear</a></li>
                                </ul>
                            </div>
                        </div>
...
<script src="js/css_to_less_converter.js"></script>
</body>
</html>