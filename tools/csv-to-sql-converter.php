                ...
                <div class="form-group buttons_div">
                    <div class="col-md-12">
                        <ul class="nav_ul ul_buttons">
                            ...
                            <li><a id="load_url" href="csv-to-sql-converter.php#">Load&nbsp;Url</a></li>
                            <li><a id="browse" href="csv-to-sql-converter.php#">Browse</a></li>
                            <li><a id="sql_insert" href="csv-to-sql-converter.php#">SQL(Insert)</a></li>
                            <li><a id="sql_update" href="csv-to-sql-converter.php#">SQL(Update)</a></li>
                            <li><a id="sql_delete" href="csv-to-sql-converter.php#">SQL(Delete)</a></li>
                            <li><a id="editor_options" data-toggle="modal" data-target="#editor_options_modal" data-backdrop="false" href="csv-to-sql-converter.php#">Editor&nbsp;Options</a></li>
                            <li><a id="download" href="csv-to-sql-converter.php#">Download</a></li>
                            <li><a id="clear" href="csv-to-sql-converter.php#">Clear</a></li>
                        </ul>
                    </div>
                </div>
