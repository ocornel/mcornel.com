...
<html lang="en">
<head>
    <link rel="stylesheet" type="text/css" href="css/csv_to_xml_converter.css" media="all"/>
                ...
                <div class="form-group buttons_div">
                    <div class="col-md-12">
                        <ul class="nav_ul ul_buttons">
                            <li><a id="load_url" href="csv-to-xml-converter.php#">Load&nbsp;Url</a></li>
                            <li><a id="browse" href="csv-to-xml-converter.php#">Browse</a></li>
                            <li><a id="csv_to_xml" href="csv-to-xml-converter.php#">CSV&nbsp;to&nbsp;XML</a></li>
                            <li><a id="beautify_xml" href="csv-to-xml-converter.php#">Beautify&nbsp;XML</a></li>
                            <li><a id="editor_options" data-toggle="modal" data-target="#editor_options_modal" data-backdrop="false" href="csv-to-xml-converter.php#">Editor&nbsp;Options</a></li>
                            <li><a id="download" href="csv-to-xml-converter.php#">Download</a></li>
                            <li><a id="clear" href="csv-to-xml-converter.php#">Clear</a></li>
                        </ul>
                    </div>
                </div>
...
<script src="js/csv_to_xml_converter.js"></script>
</body>
</html>