...
<html lang="en">
<head>
    <link rel="stylesheet" type="text/css" href="css/excel_to_html_converter.css" media="all"/></head>
...
<div class="container-fluid">
                        ...
                        <div class="form-group buttons_div">
                            <div class="col-md-12">
                                <ul class="nav_ul ul_buttons">
                                    <li><a id="browse" href="excel-to-html-converter.php#">Browse</a></li>
                                    <li><a id="convert" href="excel-to-html-converter.php#">Convert</a></li>
                                    <li><a id="preview" href="excel-to-html-converter.php#">Preview</a></li>
                                    <li><a id="beautify_html" href="excel-to-html-converter.php#">Beautify&nbsp;Html</a></li>
                                    <li><a id="editor_options" data-toggle="modal" data-target="#editor_options_modal" data-backdrop="false" href="excel-to-html-converter.php#">Editor&nbsp;Options</a></li>
                                    <li><a id="download" href="excel-to-html-converter.php#">Download</a></li>
                                    <li><a id="clear" href="excel-to-html-converter.php#">Clear</a></li>
                                </ul>
                            </div>
                        </div>
    ...
    <div class="row">
        <div class="col-md-12 text-center">
            <div class="well well-sm data_tb text-left" style="overflow:auto;display:none;">
...
<script src="js/js-xlsx/xlsx.core.min.js"></script>
<script src="js/js-xlsx/cpexcel.js"></script>
<script src="js/js-xlsx/ods.js"></script>
<script src="js/excel_to_html_converter.js"></script>
</body>
</html>