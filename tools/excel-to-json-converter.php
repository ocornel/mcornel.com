...
<html lang="en">
<head>
    <link rel="stylesheet" type="text/css" href="css/excel_to_json_converter.css" media="all"/></head>
                ...
                <div class="form-group buttons_div">
                    <div class="col-md-12">
                        <ul class="nav_ul ul_buttons">
                            <li><a id="browse" href="excel-to-json-converter.php#">Browse</a></li>
                            <li><a id="convert" href="excel-to-json-converter.php#">Convert</a></li>
                            <li><a id="beautify_json" href="excel-to-json-converter.php#">Beautify&nbsp;json</a></li>
                            <li><a id="editor_options" data-toggle="modal" data-target="#editor_options_modal" data-backdrop="false" href="excel-to-json-converter.php#">Editor&nbsp;Options</a></li>
                            <li><a id="download" href="excel-to-json-converter.php#">Download</a></li>
                            <li><a id="clear" href="excel-to-json-converter.php#">Clear</a></li>
                        </ul>
                    </div>
                </div>
...
<script src="js/excel_to_json_converter.js"></script>
</body>
</html>