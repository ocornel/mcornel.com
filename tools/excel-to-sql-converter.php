...
<html lang="en">
<head>
    <link rel="stylesheet" type="text/css" href="css/excel_to_sql_converter.css" media="all"/>
                ...
                <div class="form-group buttons_div">
                    <div class="col-md-12">
                        <ul class="nav_ul ul_buttons">
                            ...
                            <li><a id="browse" href="excel-to-sql-converter.php#">Browse</a></li>
                            <li><a id="sql_insert" href="excel-to-sql-converter.php#">SQL(Insert)</a></li>
                            <li><a id="sql_update" href="excel-to-sql-converter.php#">SQL(Update)</a></li>
                            <li><a id="sql_delete" href="excel-to-sql-converter.php#">SQL(Delete)</a></li>
                            <li><a id="editor_options" data-toggle="modal" data-target="#editor_options_modal" data-backdrop="false" href="excel-to-sql-converter.php#">Editor&nbsp;Options</a></li>
                            <li><a id="download" href="excel-to-sql-converter.php#">Download</a></li>
                            <li><a id="clear" href="excel-to-sql-converter.php#">Clear</a></li>
                        </ul>
                    </div>
                </div>
...
<script src="js/excel_to_sql_converter.js"></script>
</body>
</html>