    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3 text-center">
            <div class="well well-sm">
                <form class="form-horizontal" action="force-length-converter.php#" method="post" name="unit_converter">
                    <fieldset>

                        <!-- Text input-->
                        <div class="form-group">
                            <div class="col-md-12">
                                <input data-prop="Force / Length" id="data" name="data" type="text" placeholder="Enter a number" class="form-control input-md">
