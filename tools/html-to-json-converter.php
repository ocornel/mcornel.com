...
<html lang="en">
<head>
    <link rel="stylesheet" type="text/css" href="css/html_to_json_converter.css" media="all"/>
                ...
                <div class="form-group buttons_div">
                    <div class="col-md-12">
                        <ul class="nav_ul ul_buttons">
                            <li><a id="load_url" href="html-to-json-converter.php#">Load&nbsp;Url</a></li>
                            <li><a id="browse" href="html-to-json-converter.php#">Browse</a></li>
                            <li><a id="convert" href="html-to-json-converter.php#">Convert</a></li>
                            <li><a id="beautify_html" href="html-to-json-converter.php#">Beautify&nbsp;html</a></li>
                            <li><a id="beautify_json" href="html-to-json-converter.php#">Beautify&nbsp;JSON</a></li>
                            <li><a id="editor_options" data-toggle="modal" data-target="#editor_options_modal" data-backdrop="false" href="html-to-json-converter.php#">Editor&nbsp;Options</a></li>
                            <li><a id="download" href="html-to-json-converter.php#">Download</a></li>
                            <li><a id="clear" href="html-to-json-converter.php#">Clear</a></li>
                        </ul>
                    </div>
                </div>
...
<script src="js/html_to_json_converter.js"></script>
</body>
</html>