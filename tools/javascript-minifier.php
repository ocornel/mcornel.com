...
<html lang="en">
<head>
    <link rel="stylesheet" type="text/css" href="css/javascript_minifier.css" media="all"/>
                ...
                <div class="form-group buttons_div">
                    <div class="col-md-12">
                        <ul class="nav_ul ul_buttons">
                            <li><a id="load_url" href="javascript-minifier.php#">Load&nbsp;Url</a></li>
                            <li><a id="browse" href="javascript-minifier.php#">Browse</a></li>
                            <li><a id="minify_js" href="javascript-minifier.php#">Minify&nbsp;js</a></li>
                            <li><a id="beautify_js" href="javascript-minifier.php#">Beautify&nbsp;js</a></li>
                            <li><a id="editor_options" data-toggle="modal" data-target="#editor_options_modal" data-backdrop="false" href="javascript-minifier.php#">Editor&nbsp;Options</a></li>
                            <li><a id="download" href="javascript-minifier.php#">Download</a></li>
                            <li><a id="clear" href="javascript-minifier.php#">Clear</a></li>
                        </ul>
                    </div>
                </div>
...
<script src="js/UglifyJS2/lib/utils.js"></script>
<script src="js/UglifyJS2/lib/ast.js"></script>
<script src="js/UglifyJS2/lib/parse.js"></script>
<script src="js/UglifyJS2/lib/transform.js"></script>
<script src="js/UglifyJS2/lib/scope.js"></script>
<script src="js/UglifyJS2/lib/output.js"></script>
<script src="js/UglifyJS2/lib/compress.js"></script>
<script src="js/javascript_minifier.js"></script>
</body>
</html>