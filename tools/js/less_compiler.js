$(document).ready(function(e) {
    ...
    editorAce1.getSession().setMode("ace/mode/less");
	...
	$("#compile_less").click(function(e) {
		...
		if($.trim(data) != "")
		{
			...
			function(error) {
				...
				editorAce2.setValue("Error on line " + error.line + " column " + error.column + "\n" + error.message);
			});
		}
    });
