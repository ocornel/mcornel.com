$(document).ready(function(e) {
    ...
    editorAce1.getSession().setMode("ace/mode/scss");
	...
	$("#compile_scss").click(function(e) {
		...
		if($.trim(data) != "")
		{
			...
			$.ajax({
					...
					url		: "/get_data.php",
					dataType: "text",
					data	: {"url" : request.current},
					success : function(data_import)
					{
						if(data_import == "file_not_found"){data_import = "";}
						done({content : data_import});
					}
				});
			});
