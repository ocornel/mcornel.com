$(document).ready(function(e) {
    ...
    editorAce1.getSession().setMode("ace/mode/yaml");
	...
	$("#yaml_to_csv").click(function(e) {
		...
		if(data != "")
		{
			try {
				...
				editorAce2.setValue(jsonToCsv(json, ",", true, false, false));
			} catch (e) {
				errorData = "";
	...
	$("#validate").click(function(e) {
		...
		if(data != "")
		{
			try {
				obj = YAML.parse(data);
				editorAce2.setValue("YAML IS VALID");
			} catch (e) {
				errorData = "";
