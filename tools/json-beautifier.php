...
<html lang="en">
<head>
    <link rel="stylesheet" type="text/css" href="css/json_beautifier.css" media="all"/></head>
                ...
                <div class="form-group buttons_div">
                    <div class="col-md-12">
                        <ul class="nav_ul ul_buttons">
                            <li><a id="load_url" href="json-beautifier.php#">Load&nbsp;Url</a></li>
                            <li><a id="browse" href="json-beautifier.php#">Browse</a></li>
                            <li><a id="beautify_json" href="json-beautifier.php#">Beautify&nbsp;json</a></li>
                            <li><a id="minify_json" href="json-beautifier.php#">Minify&nbsp;json</a></li>
                            <li><a id="editor_options" data-toggle="modal" data-target="#editor_options_modal" data-backdrop="false" href="json-beautifier.php#">Editor&nbsp;Options</a></li>
                            <li><a id="download" href="json-beautifier.php#">Download</a></li>
                            <li><a id="clear" href="json-beautifier.php#">Clear</a></li>
                        </ul>
                    </div>
                </div>
...
<script src="js/json_beautifier.js"></script>
</body>
</html>