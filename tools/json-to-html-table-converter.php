...
<html lang="en">
<head>
    <link rel="stylesheet" type="text/css" href="css/json_to_html_table_converter.css" media="all"/></head>
                ...
                <div class="form-group buttons_div">
                    <div class="col-md-12">
                        <ul class="nav_ul ul_buttons">
                            <li><a id="load_url" href="json-to-html-table-converter.php#">Load&nbsp;Url</a></li>
                            <li><a id="browse" href="json-to-html-table-converter.php#">Browse</a></li>
                            <li><a id="convert" href="json-to-html-table-converter.php#">Convert</a></li>
                            <li><a id="beautify_json" href="json-to-html-table-converter.php#">Beautify&nbsp;json</a></li>
                            <li><a id="beautify_html" href="json-to-html-table-converter.php#">Beautify&nbsp;html</a></li>
                            <li><a id="preview" href="json-to-html-table-converter.php#">Preview</a></li>
                            <li><a id="editor_options" data-toggle="modal" data-target="#editor_options_modal" data-backdrop="false" href="json-to-html-table-converter.php#">Editor&nbsp;Options</a></li>
                            <li><a id="download" href="json-to-html-table-converter.php#">Download</a></li>
                            <li><a id="clear" href="json-to-html-table-converter.php#">Clear</a></li>
                        </ul>
                    </div>
                </div>
...
<script src="js/json_to_html_table_converter.js"></script>
</body>
</html>