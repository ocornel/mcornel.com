...
<html lang="en">
<head>
    <link rel="stylesheet" type="text/css" href="css/json_to_yaml_converter.css" media="all"/></head>
                ...
                <div class="form-group buttons_div">
                    <div class="col-md-12">
                        <ul class="nav_ul ul_buttons">
                            <li><a id="load_url" href="json-to-yaml-converter.php#">Load&nbsp;Url</a></li>
                            <li><a id="browse" href="json-to-yaml-converter.php#">Browse</a></li>
                            <li><a id="convert" href="json-to-yaml-converter.php#">Convert</a></li>
                            <li><a id="beautify_json" href="json-to-yaml-converter.php#">Beautify&nbsp;json</a></li>
                            <li><a id="editor_options" data-toggle="modal" data-target="#editor_options_modal" data-backdrop="false" href="json-to-yaml-converter.php#">Editor&nbsp;Options</a></li>
                            <li><a id="download" href="json-to-yaml-converter.php#">Download</a></li>
                            <li><a id="clear" href="json-to-yaml-converter.php#">Clear</a></li>
                        </ul>
                    </div>
                </div>
...
<script src="js/json_to_yaml_converter.js"></script>
</body>
</html>