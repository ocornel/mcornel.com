...
<html lang="en">
<head>
    <link rel="stylesheet" type="text/css" href="css/json_validator.css" media="all"/></head>
                ...
                <div class="form-group buttons_div">
                    <div class="col-md-12">
                        <ul class="nav_ul ul_buttons">
                            <li><a id="load_url" href="json-validator.php#">Load&nbsp;Url</a></li>
                            <li><a id="browse" href="json-validator.php#">Browse</a></li>
                            <li><a id="validate" href="json-validator.php#">Validate</a></li>
                            <li><a id="beautify_json" href="json-validator.php#">Beautify&nbsp;JSON</a></li>
                            <li><a id="editor_options" data-toggle="modal" data-target="#editor_options_modal" data-backdrop="false" href="json-validator.php#">Editor&nbsp;Options</a></li>
                            <li><a id="download" href="json-validator.php#">Download</a></li>
                            <li><a id="clear" href="json-validator.php#">Clear</a></li>
                        </ul>
                    </div>
                </div>
...
<script src="js/json_validator.js"></script>
</body>
</html>