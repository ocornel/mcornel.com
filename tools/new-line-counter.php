...
<html lang="en">
<head>
    <link rel="stylesheet" type="text/css" href="css/new_line_counter.css" media="all"/></head>
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2 text-center">
            <div class="well well-sm">
                <form class="form-horizontal txt_form" action="new-line-counter.php#" method="post">
                    <fieldset>
            ...
            <div class="well well-sm"><p><strong>Number of lines:&nbsp;<span class="results" style="color:#FF0000;">0</span></strong></p></div>
        </div>
    </div>
...
<script src="js/new_line_counter.js"></script>
</body>
</html>