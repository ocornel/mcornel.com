...
<html lang="en">
<head>
    <link rel="stylesheet" type="text/css" href="css/php_beautifier.css" media="all"/></head>
                ...
                <div class="form-group buttons_div">
                    <div class="col-md-12">
                        <ul class="nav_ul ul_buttons">
                            <li><a id="load_url" href="php-beautifier.php#">Load&nbsp;Url</a></li>
                            <li><a id="browse" href="php-beautifier.php#">Browse</a></li>
                            <li><a id="beautify_php" href="php-beautifier.php#">Beautify&nbsp;PHP</a></li>
                            <li><a id="options" href="php-beautifier.php#">Options</a></li>
                            <li><a id="editor_options" data-toggle="modal" data-target="#editor_options_modal" data-backdrop="false" href="php-beautifier.php#">Editor&nbsp;Options</a></li>
                            <li><a id="download" href="php-beautifier.php#">Download</a></li>
                            <li><a id="clear" href="php-beautifier.php#">Clear</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form>
                            <fieldset>
                                <div class="form-group">
                                    <label for="indentation_style">Indentation style</label>
                                    <select id="indentation_style" name="indentation_style" class="form-control">
                                        <option value="k&r">K&amp;R style (One true brace style)</option>
                                        <option value="allman" selected>Allman style (BSD style)</option>
                                        <option value="whitesmiths">Whitesmiths style</option>
                                        <option value="gnu">GNU style</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="indent_with">Indent with</label>
                                    <select id="indent_with" name="indent_with" class="form-control">
                                        <option value="spaces">Spaces</option>
                                        <option value="tabs">Tabs</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="indentation_size">Indentation size</label>
                                    <select id="indentation_size" name="indentation_size" class="form-control">
                                ...
                                <div class="checkbox">
                                    <label for="ArrayNested">
                                        <input name="checkboxes" id="ArrayNested" value="ArrayNested" type="checkbox" checked>Indent the array structures
                                    </label>
                                </div>
                                <div class="checkbox">
                                    <label for="EqualsAlign">
                                        <input name="checkboxes" id="EqualsAlign" value="EqualsAlign" type="checkbox">Align the equals symbols in contiguous lines
                                    </label>
                                </div>
                                <div class="checkbox">
                                    <label for="Fluent">
                                        <input name="checkboxes" id="Fluent" value="Fluent" type="checkbox" checked>Create fluent style for multi-level object access
                                    </label>
                                </div>
                                <div class="checkbox">
                                    <label for="KeepEmptyLines">
                                        <input name="checkboxes" id="KeepEmptyLines" value="KeepEmptyLines" type="checkbox" checked>Keep a single empty line where empty lines can be found
                                    </label>
                                </div>
                                <div class="checkbox">
                                    <label for="ListClassFunction">
                                        <input name="checkboxes" id="ListClassFunction" value="ListClassFunction" type="checkbox">Create a list of functions and classes in the script
                                    </label>
                                </div>
                                <div class="checkbox">
                                    <label for="Lowercase">
                                        <input name="checkboxes" id="Lowercase" value="Lowercase" type="checkbox" checked>Lowercase all control structures
                                    </label>
                                </div>
                            </fieldset>
                        </form>
...
<script src="js/php_beautifier.js"></script>
</body>
</html>