...
<html lang="en">
<head>
    <link rel="stylesheet" type="text/css" href="css/scss_compiler.css" media="all"/>
                        ...
                        <div class="form-group buttons_div">
                            <div class="col-md-12">
                                <ul class="nav_ul ul_buttons">
                                    <li><a id="load_url" href="scss-compiler.php#">Load&nbsp;Url</a></li>
                                    <li><a id="browse" href="scss-compiler.php#">Browse</a></li>
                                    <li><a id="compile_scss" href="scss-compiler.php#">Compile&nbsp;scss</a></li>
                                    <li><a id="beautify_css" href="scss-compiler.php#">Beautify&nbsp;css</a></li>
                                    <li><a id="minify_css" href="scss-compiler.php#">Minify&nbsp;css</a></li>
                                    <li><a id="editor_options" data-toggle="modal" data-target="#editor_options_modal" data-backdrop="false" href="scss-compiler.php#">Editor&nbsp;Options</a></li>
                                    <li><a id="download" href="scss-compiler.php#">Download</a></li>
                                    <li><a id="clear" href="scss-compiler.php#">Clear</a></li>
                                </ul>
                            </div>
                        </div>
...
<script src="js/scss_compiler.js"></script>
</body>
</html>