...
<html lang="en">
<head>
    <link rel="stylesheet" type="text/css" href="css/social_popularity_checker.css" media="all"/>
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3 text-center">
            <div class="well well-sm">
                ...
                <form class="form-horizontal" action="social-popularity-checker.php#" method="post">
                    <fieldset>
...
<script src="js/social_popularity_checker.js"></script>
</body>
</html>