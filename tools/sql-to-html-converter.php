...
<html lang="en">
<head>
    <link rel="stylesheet" type="text/css" href="css/sql_to_html_converter.css" media="all"/></head>
                ...
                <div class="form-group buttons_div">
                    <div class="col-md-12">
                        <ul class="nav_ul ul_buttons">
                            <li><a id="load_url" href="sql-to-html-converter.php#">Load&nbsp;Url</a></li>
                            <li><a id="browse" href="sql-to-html-converter.php#">Browse</a></li>
                            <li><a id="convert" href="sql-to-html-converter.php#">Convert</a></li>
                            <li><a id="beautify_html" href="sql-to-html-converter.php#">Beautify&nbsp;html</a></li>
                            <li><a id="preview" href="sql-to-html-converter.php#">Preview</a></li>
                            <li><a id="editor_options" data-toggle="modal" data-target="#editor_options_modal" data-backdrop="false" href="sql-to-html-converter.php#">Editor&nbsp;Options</a></li>
                            <li><a id="download" href="sql-to-html-converter.php#">Download</a></li>
                            <li><a id="clear" href="sql-to-html-converter.php#">Clear</a></li>
                        </ul>
                    </div>
                </div>
