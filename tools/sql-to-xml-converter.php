...
<html lang="en">
<head>
    <link rel="stylesheet" type="text/css" href="css/sql_to_xml_converter.css" media="all"/></head>
                ...
                <div class="form-group buttons_div">
                    <div class="col-md-12">
                        <ul class="nav_ul ul_buttons">
                            <li><a id="load_url" href="sql-to-xml-converter.php#">Load&nbsp;Url</a></li>
                            <li><a id="browse" href="sql-to-xml-converter.php#">Browse</a></li>
                            <li><a id="convert" href="sql-to-xml-converter.php#">Convert</a></li>
                            <li><a id="beautify_xml" href="sql-to-xml-converter.php#">Beautify&nbsp;xml</a></li>
                            <li><a id="editor_options" data-toggle="modal" data-target="#editor_options_modal" data-backdrop="false" href="sql-to-xml-converter.php#">Editor&nbsp;Options</a></li>
                            <li><a id="download" href="sql-to-xml-converter.php#">Download</a></li>
                            <li><a id="clear" href="sql-to-xml-converter.php#">Clear</a></li>
                        </ul>
                    </div>
                </div>
...
<script src="js/sql_to_xml_converter.js"></script>
</body>
</html>