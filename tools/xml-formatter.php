...
<html lang="en">
<head>
    <link rel="stylesheet" type="text/css" href="css/xml_beautifier.css" media="all"/></head>
                ...
                <div class="form-group buttons_div">
                    <div class="col-md-12">
                        <ul class="nav_ul ul_buttons">
                            <li><a id="load_url" href="xml-beautifier.php#">Load&nbsp;Url</a></li>
                            <li><a id="browse" href="xml-beautifier.php#">Browse</a></li>
                            <li><a id="beautify_xml" href="xml-beautifier.php#">Beautify&nbsp;xml</a></li>
                            <li><a id="minify_xml" href="xml-beautifier.php#">Minify&nbsp;xml</a></li>
                            <li><a id="editor_options" data-toggle="modal" data-target="#editor_options_modal" data-backdrop="false" href="xml-beautifier.php#">Editor&nbsp;Options</a></li>
                            <li><a id="download" href="xml-beautifier.php#">Download</a></li>
                            <li><a id="clear" href="xml-beautifier.php#">Clear</a></li>
                        </ul>
                    </div>
                </div>
...
<script src="js/xml_beautifier.js"></script>
</body>
</html>