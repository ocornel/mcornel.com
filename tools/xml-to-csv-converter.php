...
<html lang="en">
<head>
    <link rel="stylesheet" type="text/css" href="css/xml_to_csv_converter.css" media="all"/></head>
                ...
                <div class="form-group buttons_div">
                    <div class="col-md-12">
                        <ul class="nav_ul ul_buttons">
                            <li><a id="load_url" href="xml-to-csv-converter.php#">Load&nbsp;Url</a></li>
                            <li><a id="browse" href="xml-to-csv-converter.php#">Browse</a></li>
                            <li><a id="xml_to_csv" href="xml-to-csv-converter.php#">XML&nbsp;to&nbsp;CSV</a></li>
                            <li><a id="beautify_xml" href="xml-to-csv-converter.php#">Beautify&nbsp;XML</a></li>
                            <li><a id="editor_options" data-toggle="modal" data-target="#editor_options_modal" data-backdrop="false" href="xml-to-csv-converter.php#">Editor&nbsp;Options</a></li>
                            <li><a id="download" href="xml-to-csv-converter.php#">Download</a></li>
                            <li><a id="clear" href="xml-to-csv-converter.php#">Clear</a></li>
                        </ul>
                    </div>
                </div>
...
<script src="js/x2json.min.js"></script>
<script src="js/xml_to_csv_converter.js"></script>
</body>
</html>