...
<html lang="en">
<head>
    <link rel="stylesheet" type="text/css" href="css/xml_to_json_converter.css" media="all"/></head>
                ...
                <div class="form-group buttons_div">
                    <div class="col-md-12">
                        <ul class="nav_ul ul_buttons">
                            <li><a id="load_url" href="xml-to-json-converter.php#">Load&nbsp;Url</a></li>
                            <li><a id="browse" href="xml-to-json-converter.php#">Browse</a></li>
                            <li><a id="convert" href="xml-to-json-converter.php#">Convert</a></li>
                            <li><a id="beautify_xml" href="xml-to-json-converter.php#">Beautify&nbsp;xml</a></li>
                            <li><a id="beautify_json" href="xml-to-json-converter.php#">Beautify&nbsp;json</a></li>
                            <li><a id="minify_xml" href="xml-to-json-converter.php#">Minify&nbsp;xml</a></li>
                            <li><a id="minify_json" href="xml-to-json-converter.php#">Minify&nbsp;json</a></li>
                            <li><a id="editor_options" data-toggle="modal" data-target="#editor_options_modal" data-backdrop="false" href="xml-to-json-converter.php#">Editor&nbsp;Options</a></li>
                            <li><a id="download" href="xml-to-json-converter.php#">Download</a></li>
                            <li><a id="clear" href="xml-to-json-converter.php#">Clear</a></li>
                        </ul>
                    </div>
                </div>
...
<script src="js/xml_to_json_converter.js"></script>
</body>
</html>