...
<html lang="en">
<head>
    <link rel="stylesheet" type="text/css" href="css/xml_validator.css" media="all"/></head>
                ...
                <div class="form-group buttons_div">
                    <div class="col-md-12">
                        <ul class="nav_ul ul_buttons">
                            <li><a id="load_url" href="xml-validator.php#">Load&nbsp;Url</a></li>
                            <li><a id="browse" href="xml-validator.php#">Browse</a></li>
                            <li><a id="validate" href="xml-validator.php#">Validate</a></li>
                            <li><a id="beautify_xml" href="xml-validator.php#">Beautify&nbsp;XML</a></li>
                            <li><a id="editor_options" data-toggle="modal" data-target="#editor_options_modal" data-backdrop="false" href="xml-validator.php#">Editor&nbsp;Options</a></li>
                            <li><a id="download" href="xml-validator.php#">Download</a></li>
                            <li><a id="clear" href="xml-validator.php#">Clear</a></li>
                        </ul>
                    </div>
                </div>
...
<script src="js/xml_validator.js"></script>
</body>
</html>